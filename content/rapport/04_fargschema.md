...
Den typ av färgschema som används är ett monokromatiskt färgschema, där röd är basfärgen och det finns olika nyanser av detta i accentfärgen runt om i sidan.
...
Den typ av färgschema som används är ett complementary färgschema, där vit är basfärgen och det finns tre komplementfärger, grön, gul och blå, vilka används som accentfärger för en kraftfull kontrast till basfärgen.

<h5 style="border-bottom: none">Typsnitt</h5>
**`<h1>`**,  **`<p>`** , **<`h4`>** & brödtext = "'Roboto'"

När det gäller typsnitten så används den ”Roboto” fonten på nästan hela sidan.  Enligt Wikipedia, https://en.wikipedia.org/wiki/Roboto, så är ”Roboto” en ”sans-serif” font som är skapad från Google som en modern font till mobila enheter.  Typsnitten är klar, tydlig och lättläst.  Färgen på rubrikerna är svart och alla paragrafer är av en mörkgrå variant.

Jag tror att Elgigantens färgschema och typsnitt motsvarar den profil webbplatsen vill ha, där själva produkterna och annonser sätter fokus på hela sidan.  Typsnitten är tydlig, lockande samt lättläst och ser bra ut på alla digitala enheter.  Kontrasten med den vita bakgrunden lyfter fram produktbilder rejält samt accentfärgarna hjälper till med navigeringen och lyfter fram viktig information.  Det enda negativa jag kan säga är navbaren, den är lite för mycket vit och ibland känns det svårt att hitta vart man ska och vart man är.  Jag känner att websidans design är lite steril för min smak men fungera bra för ändamålet.
...
<tr>
<caption style="text-align: center">Färgschema</caption>
<td style="height: 50px; width: 50px; background-color: #da0b22">
<td style="height: 50px; width: 50px; background-color: #fff">
<td style="height: 50px; width: 50px; background-color: #b22e29">
<td style="height: 50px; width: 50px; background-color: #f1ece6">
<td style="height: 50px; width: 50px; background-color: #35a647">
</tr>
</table>
<table style="border-spacing: 4px; border-collapse: separate">
<tr>
...
Den typ av färgschema som används är ett complementary färgschema, där röd är basfärgen och det finns flera komplementfärger, grön samt många olika färgar kopplat till sin avdelnings färgkod.  Dessa används som accentfärger för en kraftfull kontrast till basfärgen samt lättare navigering.
